...
See [Live testing against AWS MSK](https://github.com/newvoll/kafkareport/blob/main/livetest/README.md) for details on how to quickly smoke test against actual clusters.
